...
class MongoDriver:
    ...
    def __init__(self, db_dict: dict):
        try:
            ...
            self.client = pymongo.MongoClient(self.DATABASE_HOST, username=self.DATABASE_ADMIN_USERNAME, password=self.DATABASE_ADMIN_PASSWORD, authSource="admin") #  authSource="admin"
            # deprecated
